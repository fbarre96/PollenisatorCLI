...
class DefectView(ViewElement):
    ...
    def __init__(self, controller, parent_context, prompt_session, **kwargs):
        ...
        self.fields = [
            ...
            ListParameter("types", default=self.controller.model.mtype, validator=lambda value, field: "" if value in defect_types else "Not a valid type", completor=lambda args, field: defect_types),
