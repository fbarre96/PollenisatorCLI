...
from core.Parameters.parameter import Parameter, TableParameter, ComboParameter, BoolParameter, ListParameter
...
class PentestSettings(FormModule):
    ...
    def save(self):
        ...
        """
        values = Parameter.getParametersValues(self.fields)
        settings_dict = {"pentest_type":values["pentest_type"], "pentesters": values["pentesters"], "include_domains_with_ip_in_scope":values["check_new_domain_ip_scope"],
